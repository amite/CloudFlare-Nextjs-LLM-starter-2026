    ...
    <main className="mx-auto max-w-4xl px-4 py-12">
      ...
      <div className="mt-8 rounded-md border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800/50">
        ...
        <ul className="space-y-1 text-sm text-gray-600 dark:text-gray-400">
          ...
          <li>
            • Middleware at{" "}
            <code className="rounded bg-gray-200 px-1 dark:bg-gray-700">middleware.ts</code> protects
            the <code className="rounded bg-gray-200 px-1 dark:bg-gray-700">/dashboard</code> route
          </li>
